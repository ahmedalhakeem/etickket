# Generated by Django 3.1.3 on 2021-02-06 17:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ticket_priority', models.CharField(choices=[('مهمة جدا', 'مهمة جدا'), ('مهمة', 'مهمة'), ('متوسطة الاهمية', 'غير مهمة ')], default='مهمة جدا', max_length=14)),
                ('ticket_status', models.CharField(choices=[('accomplished', 'تم الانجاز'), ('unaccomplished', 'لم يتم الانجاز')], default='unaccomplished', max_length=30)),
                ...
                ('it_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='it_user', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='user',
